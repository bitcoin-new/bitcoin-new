...
public:
    ...
    // Whether the node uses the bitcoin new magic to communicate.
    std::atomic<bool> fUsesNewMagic;
...
public:
    ...
    GetMagic(const CChainParams &params) const {
        return fUsesNewMagic ? params.MessageStart()
    ...
    bool IsLegacyBlockHeader(int version) { return version < BTN_HARD_FORK_VERSION; };
};
