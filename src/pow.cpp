...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    bool postfork = nHeight >= params.BTNHeight;
    ...
    else if (nHeight < params.BTNHeight + params.BTNPremineWindow) {
        return nProofOfWorkLimit;
    }
    else if (nHeight < params.BTNHeight + params.BTNPremineWindow + params.nPowAveragingWindow){
