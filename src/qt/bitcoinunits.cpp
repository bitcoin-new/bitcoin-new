...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTN: return QString("Bitcoins");
    case mBTN: return QString("Milli-Bitcoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTN: return QString("Micro-Bitcoins (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
