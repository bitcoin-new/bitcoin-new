...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-bootstrap", _("Enables Bitcoin New bootstrap mode. Allows BTN client to connect to Bitcoin p2p network to download blockahin history."));
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    fBTNBootstrapping = gArgs.GetBoolArg("-bootstrap", false);
