...
Source10:	https://raw.githubusercontent.com/bitcoin-new/bitcoin-new/master/contrib/debian/examples/bitcoinnew.conf
...
cp -p %{SOURCE10} ./bitcoinnew.conf.example
tar -zxf %{SOURCE1}
...
cat <<EOF > %{buildroot}%{_tmpfilesdir}/bitcoinnew.conf
d /run/bitcoind 0750 bitcoin bitcoin -
EOF
touch -a -m -t 201504280000 %{buildroot}%{_tmpfilesdir}/bitcoinnew.conf
...
CONFIG_FILE="%{_sysconfdir}/bitcoin/bitcoinnew.conf"
DATA_DIR="%{_localstatedir}/lib/bitcoin"
PID_FILE="/run/bitcoind/bnewd.pid"
EOF
...
%doc COPYING bitcoinnew.conf.example doc/README.md doc/bips.md doc/files.md doc/multiwallet-qt.md doc/reduce-traffic.md doc/release-notes.md doc/tor.md
...
%defattr(-,root,root,-)
%license COPYING db-%{bdbv}.NC-LICENSE
%doc COPYING bitcoinnew.conf.example doc/README.md doc/REST-interface.md doc/bips.md doc/dnsseed-policy.md doc/files.md doc/reduce-traffic.md doc/release-notes.md doc/tor.md
%attr(0755,root,root) %{_sbindir}/bitcoind
%attr(0644,root,root) %{_tmpfilesdir}/bitcoinnew.conf
...
%defattr(-,root,root,-)
%license COPYING
%doc COPYING bitcoinnew.conf.example doc/README.md
